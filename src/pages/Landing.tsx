      ...
      <div className="relative z-10">
        ...
        <section className="relative min-h-[85vh] flex items-center justify-center px-6 py-20">
          ...
          <div className="relative max-w-3xl mx-auto">
            ...
            >
              {/* Tagline */}
              <span className="inline-block font-mono text-xs tracking-widest uppercase text-[#D0BCFF] mb-6">
              ...
              {/* Subhead */}
              <p className="font-plain text-[#938F99] text-lg md:text-xl leading-relaxed mb-10 max-w-xl">
                A dedicated command center for the Australian Community Services sector. Manage Key Selection Criteria, case logs, and WWCC checks.
              </p>
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <button 
                  className="inline-flex items-center gap-2 bg-transparent border border-[#49454F] text-[#E6E0E9] font-medium px-8 py-4 rounded-full transition-all duration-300 hover:border-[#938F99] hover:bg-[#1E1E1E]"
                >
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {toolkitCards.map((card, index) => (
                <div 
                  key={index}
                  className="group bg-[#2C2C2C] border border-[#49454F] rounded-[16px] p-6 transition-all duration-300 hover:border-[#8A9A5B] hover:bg-[#2C2C2C]/80"
                >
                  {/* Icon */}

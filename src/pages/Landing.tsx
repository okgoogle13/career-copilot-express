...
const Landing = () => {
  ...
  return (
    <div className="h-screen overflow-hidden bg-[#121212] flex flex-col relative">
      {/* Floating Navigation */}
      <FloatingNav />
      ...
      <main className="flex-1 flex flex-col relative z-10 pt-14 px-4 md:px-8">
        ...
        <section className="flex-1 flex items-center justify-center relative">
          ...
          >
            <div
              className="w-[280px] md:w-[350px] lg:w-[420px] translate-x-8 md:translate-x-16"
              style={{
          ...
          >
            <motion.div
              ...
              className="bg-[#1E1E1E]/30 backdrop-blur-2xl border border-[#49454F] px-6 py-5 md:px-8 md:py-6 rounded-tl-3xl rounded-tr-[4rem] rounded-br-3xl rounded-bl-lg"
            >
              {/* Tagline */}
              <motion.span
                variants={itemVariants}
                className="inline-block font-mono text-[10px] tracking-widest uppercase text-[#D0BCFF] mb-3"
              >
              ...
              <motion.p
                variants={itemVariants}
                className="text-[#938F99] text-sm mb-4 max-w-md leading-relaxed"
              ...
              <motion.div variants={itemVariants} className="flex flex-wrap gap-3">
                ...
                <Link
                  to="/dashboard"
                  className="inline-flex items-center gap-2 bg-[#8A9A5B] text-[#121212] font-bold px-5 py-2.5 rounded-full transition-all duration-200 hover:bg-[#9AB065] hover:scale-105 text-sm"
                >
                  Enter Workspace
                ...
                <a
                  href="#"
                  className="inline-flex items-center gap-2 border border-[#49454F] text-[#E3E3E3] font-medium px-5 py-2.5 rounded-full transition-all duration-200 hover:border-[#8A9A5B] hover:text-white text-sm"
                >
            ...
            {toolkitCards.map((card, index) => (
              ...
              >
                <motion.div
                  ...
                  className="h-full bg-[#2C2C2C] border border-[#49454F] rounded-[16px] p-4 cursor-pointer"
                ...
                >
                  ...
                  {/* Description */}
                  <p
                    className="text-[#938F99] text-xs leading-snug"
                    style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}
                  >
                    {card.description}
                  </p>
      ...
      <motion.footer
        ...
        transition={{ delay: 0.3, duration: 0.4, ease: m3Emphasized }}
